...
# Window Size
application.geometry('1150x630+0+0')
...
# Product Lists
food_list = ['Chicken', 'Lamb', 'Salmon', 'Hake', 'Kebabs', 'Hake', 'Pizza1', 'Pizza2']
drink_list = ['Lemonade', 'Soda', 'Juice', 'Cola', 'Water','Coffee','Tea', 'Cold Coffee']
dessert_list = ['Ice Cream', 'Fruit', 'Brownies', 'Pudding', 'Cheese Cake', 'Cake1', 'Cake2', 'Biscuits']
